...
public class TableCreator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Time.time - startTime > timeLimit && counter > 0)
        {
    ...
    void LoadTable(JSONParser json)
    {
        ...
        float widthScale = parentCanvas.GetComponent<RectTransform>().rect.width / panel.GetComponent<RectTransform>().rect.width;
        float heightScale = 1050.0f / panel.GetComponent<RectTransform>().rect.height;
        Debug.Log("height is " + panel.GetComponent<RectTransform>().rect.height);
        float scale;
        ...
        {
            Color normalColor = new Color(0.130f, 0.130f, 0.150f, 1);
